...
const FIELDS = 'id,name,segment,tier,status,kyc_status,aml_status,asset_classes,order_routing,colo,market_data,hosting,cross_connect,avg_daily_volume_usd,aum_usd,jurisdiction,website,notes,sales_owner_id,service_manager_id,created_at,sales_owner:sales_owner_id(id,full_name,email,avatar_url),service_manager:service_manager_id(id,full_name,email,avatar_url)';
